...
INSERT INTO courses VALUES (2, 'Cloud Computing', 7, 40, 'Welcome to Cloud Computing! This course provides an introduction to cloud computing, with a focus on building cloud-deployed web applications.');
...
INSERT INTO assignments VALUES (2, 1, '05/16/2022', 100, 'Assignment 6', 'Follow the instructions to get NodeJS and ExpressJS set up on your machine. NodeJS: https://nodejs.org/en/download/ . ExpressJS: https://expressjs.com/en/starter/installing.html . Once your ExpressJS server is ready, submit a screenshot(s) of the browser and your console showing that the server is running (i.e. accepting requests and sending responses). The screenshot must show the browser URL, your name, and date/time. ');
